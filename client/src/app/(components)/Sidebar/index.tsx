...
import { AlertCircle, AlertOctagon, AlertTriangle, Briefcase, ChevronDown, ChevronUp, Home, Layers3Icon, LockIcon, LucideIcon, Search, Settings, ShieldAlert, User, Users, X } from 'lucide-react';
    ...
    <div className={sidebarClassNames}>
        <div className="flex h-[100%] w-full flex-col justify-start">
            ...
            <div className="z-50 flex min-h-[56px] w-64 items-center justify-between bg-white px-6 pt-3 dark:bg-black">
                <div className="text-xl font-bold text-gray-800 dark:text-white">Manager</div>
            ...
            {showProjects && (
              <>
                ...
                <SidebarLink icon={Briefcase} label="Product Design Development" href="/project"/>
...
const SidebarLink = ({href, icon:Icon, label}: SidebarLinkProps)=>{
  ...
  return(
    <Link href={href} className="w-full">
      <div className={`relative flex cursor-pointer items-center gap-3 transition-colors hover:bg-gray-100 dark:bg-black dark:hover:bg-gray-700 ${isActive ? "bg-gray-100" : ""} justify-start px-8 py-3 `}>
